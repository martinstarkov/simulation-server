...
pub struct RegisterRequest {
    ...
    /// if true, this client participates in the step barrier
    #[prost(bool, tag = "2")]
...
pub struct ClientMsg {
    #[prost(oneof = "client_msg::Msg", tags = "1, 2, 3, 4, 5")]
    pub msg: ::core::option::Option<client_msg::Msg>,
}
...
pub struct ServerMsg {
    #[prost(oneof = "server_msg::Msg", tags = "1, 2, 3, 4")]
    pub msg: ::core::option::Option<server_msg::Msg>,
}
...
pub mod server_msg {
    ...
    pub enum Msg {
        #[prost(message, tag = "1")]
        Registered(super::RegisterResponse),
        #[prost(message, tag = "2")]
        Tick(super::Tick),
...
pub mod simulator_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/interface.Simulator/Open");
...
pub mod simulator_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/interface.Simulator/Open" => {
                    #[allow(non_camel_case_types)]
                    struct OpenSvc<T: Simulator>(pub Arc<T>);
                    impl<T: Simulator> tonic::server::StreamingService<super::ClientMsg>
                    for OpenSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Simulator>::open(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "interface.Simulator";
